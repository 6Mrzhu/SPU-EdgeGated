...
# from network.SPUUNet import SPUUNet as CRNet

#from network.SPUUNet2 import SPUUNet as CRNet

from network.SPUUNet import SPUUNet as CRNet


from network.model_loss import CD_dist
from network.model1 import Model
...
parser.add_argument('--log_dir', default='../model/demo/release2',
                    help='Log dir [default: log]')
parser.add_argument('--result_dir', default="../model/test/result",
                    help='result directory')
parser.add_argument('--ckpt',default='../model/demo/release2/release/model_40.pth',
...
# parser.add_argument('--test_data', default='../data/PU1K/test/input_2048/input_2048',
#                     help='test data path')
parser.add_argument('--test_data', default='../data/kitti',
                    help='test data path')
parser.add_argument('--gt_path', default='../data/PU1K/test/input_2048/gt_1024',
...
parser.add_argument('--restore_epoch', type=int, default=40)
...
def train(conf):
    ...
    for epoch in range(start_epoch, conf.max_epoch + 1):
        ...
        for i, examples in enumerate(dataloader):
            ...
            print(input_pc.shape)  #(32,3,1024)
   ...
   # print(num_patches)
    for k in range(num_patches):
       ...
       # print(patch.shape)   #[1,3,256]
        ...
        # print(x.shape)
        up_point = net.forward(patch.detach().permute(0,2,1).contiguous() )
...
def test1(result_dir, net=None, shape_count=39726):  #2048
...
def offline_test(result_dir):
    ...
    net.eval()
    target_folder = test(result_dir, net, shape_count=int(args.num_shape_point*8))
